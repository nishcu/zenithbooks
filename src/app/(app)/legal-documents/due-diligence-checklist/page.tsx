...
export default function DueDiligenceChecklistPage() {
  ...
  useOnDemandUnlock("due_diligence_checklist_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Due Diligence Checklist Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Comprehensive due diligence checklist for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="due_diligence_checklist_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Due_Diligence_Checklist_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="due_diligence_checklist"
                        documentName={`Due_Diligence_Checklist_${formData.employeeName}`}
