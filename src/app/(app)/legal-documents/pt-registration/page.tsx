...
export default function PTRegistrationPage() {
  ...
  useOnDemandUnlock("pt_registration_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">PT Registration Draft Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Application for Professional Tax registration for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="pt_registration_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`PT_Registration_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="pt_registration"
                        documentName={`PT_Registration_${formData.employeeName}`}
