...
export default function PartnershipDissolutionPage() {
  ...
  useOnDemandUnlock("partnership_dissolution_download", () => setShowDocument(true));

  const { handleCertificationRequest, handlePaymentSuccess, isSubmitting: isCertifying } = useCertificationRequest({
    pricing,
    serviceId: 'partnership_dissolution'
  });
        ...
        return (
             <Card>
                ...
                <CardFooter className="justify-between mt-6">
                  ...
                  {(() => {
                    const basePrice = pricing?.agreements?.find(s => s.id === 'partnership_dissolution')?.price || 0;
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="partnership_dissolution_download"
                        planName="Service Agreement Download"
                        amount={effectivePrice}
                        fileName={`Partnership_Dissolution_${formData.clientName}`}
                        contentRef={printRef}
                        documentType="partnership_dissolution"
                        documentName={`Partnership_Dissolution_${formData.clientName}`}
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Partnership Dissolution Deed Generator</h1>
        <p className="text-muted-foreground">Deed for dissolving a partnership.</p>
      </div>
      <Form {...form}>
      ...
      {step === 3 && (
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>Get your Service Agreement professionally reviewed and certified by a qualified legal expert.</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter>
            {pricing && pricing.agreements?.find(s => s.id === 'partnership_dissolution')?.price > 0 ? (
              <CashfreeCheckout
                amount={pricing.agreements.find(s => s.id === 'partnership_dissolution')?.price || 0}
                planId="partnership_dissolution_certification"
                ...
                onSuccess={(paymentId) => {
                  handlePaymentSuccess(paymentId, {
                    reportType: "Service Agreement Certification",
