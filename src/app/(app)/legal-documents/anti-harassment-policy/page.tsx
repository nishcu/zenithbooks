...
export default function AntiHarassmentPolicyPage() {
  ...
  useOnDemandUnlock("anti_harassment_policy_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Anti-Harassment Policy Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Prevention of sexual harassment policy. for your organization.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="anti_harassment_policy_download"
                        planName="Remote Work Policy Download"
                        amount={effectivePrice}
                        fileName={`Anti_Harassment_Policy_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="anti_harassment_policy"
                        documentName={`Anti_Harassment_Policy_${formData.companyName}`}
