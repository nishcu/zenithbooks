...
export default function TravelPolicyPage() {
  ...
  useOnDemandUnlock("travel_policy_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Travel Policy Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Business travel and accommodation policy. for your organization.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="travel_policy_download"
                        planName="Remote Work Policy Download"
                        amount={effectivePrice}
                        fileName={`Travel_Policy_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="travel_policy"
                        documentName={`Travel_Policy_${formData.companyName}`}
