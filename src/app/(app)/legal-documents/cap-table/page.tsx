...
export default function CapTablePage() {
  ...
  useOnDemandUnlock("cap_table_document_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Cap Table Document Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Capitalization table template for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="cap_table_document_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Cap_Table_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="cap_table_document"
                        documentName={`Cap_Table_${formData.employeeName}`}
