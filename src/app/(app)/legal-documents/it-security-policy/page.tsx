...
export default function ITSecurityPolicyPage() {
  ...
  useOnDemandUnlock("it_security_policy_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">IT Security Policy Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Information technology security and usage policy. for your organization.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="it_security_policy_download"
                        planName="Remote Work Policy Download"
                        amount={effectivePrice}
                        fileName={`It_Security_Policy_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="it_security_policy"
                        documentName={`It_Security_Policy_${formData.companyName}`}
