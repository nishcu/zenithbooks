...
export default function GiftDeedPage() {
  ...
  useOnDemandUnlock("gift_deed_download", () => setShowDocument(true));
        ...
        return (
             <Card>
                ...
                <CardFooter className="justify-between mt-6">
                  ...
                  {(() => {
                    const basePrice = pricing?.agreements?.find(s => s.id === 'gift_deed')?.price || 0;
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="gift_deed_download"
                        planName="Service Agreement Download"
                        amount={effectivePrice}
                        fileName={`Gift_Deed_${formData.clientName}`}
                        contentRef={printRef}
                        documentType="gift_deed"
                        documentName={`Gift_Deed_${formData.clientName}`}
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Gift Deed Generator</h1>
        <p className="text-muted-foreground">Legal deed for gifting property/assets.</p>
      </div>
      <Form {...form}>
      ...
      {step === 3 && (
        <Card className="mt-8">
          ...
          <CardFooter>
            {pricing && pricing.agreements?.find(s => s.id === 'gift_deed')?.price > 0 ? (
              <CashfreeCheckout
                amount={pricing.agreements.find(s => s.id === 'gift_deed')?.price || 0}
                planId="gift_deed_certification"
