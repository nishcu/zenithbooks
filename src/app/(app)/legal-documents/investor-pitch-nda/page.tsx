...
export default function InvestorPitchNDAPage() {
  ...
  useOnDemandUnlock("investor_pitch_nda_download", () => setShowDocument(true));

  const { handleCertificationRequest, handlePaymentSuccess, isSubmitting: isCertifying } = useCertificationRequest({
    pricing,
    serviceId: 'investor_pitch_nda'
  });
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 3:
        ...
        return (
             <Card>
                <CardHeader><CardTitle>Final Step: Preview & Download</CardTitle><CardDescription>Review the generated Investor Pitch NDA.</CardDescription></CardHeader>
                <CardContent>
                  <div ref={printRef} className="prose prose-sm dark:prose-invert max-w-none border rounded-md p-6 bg-muted/20 leading-relaxed">
                    ...
                    <p>This Investor Pitch NDA (the "Agreement") is entered into as of <strong>{agreementDate}</strong> (the "Effective Date"),</p>
                ...
                <CardFooter className="justify-between mt-6">
                  ...
                  {(() => {
                    const basePrice = pricing?.agreements?.find(s => s.id === 'investor_pitch_nda')?.price || 0;
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="investor_pitch_nda_download"
                        planName="NDA Download"
                        amount={effectivePrice}
                        fileName={`Investor_Pitch_NDA_${formData.disclosingPartyName}_${formData.receivingPartyName}`}
                        contentRef={printRef}
                        documentType="nda"
                        documentName={`Investor_Pitch_NDA_${formData.disclosingPartyName}_${formData.receivingPartyName}`}
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Investor Pitch NDA Generator</h1>
      ...
      {step === 3 && (
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>Get your NDA professionally reviewed and certified by a qualified legal expert.</CardDescription>
          </CardHeader>
          <CardContent>
