...
export default function CashFlowProjectionPage() {
  ...
  useOnDemandUnlock("cash_flow_projection_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Cash Flow Projection Format Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Template for cash flow projections. for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="cash_flow_projection_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Cash_Flow_Projection_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="cash_flow_projection"
                        documentName={`Cash_Flow_Projection_${formData.employeeName}`}
