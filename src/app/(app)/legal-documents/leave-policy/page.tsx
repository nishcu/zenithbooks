...
export default function LeavePolicyPage() {
  ...
  useOnDemandUnlock("leave_policy_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Leave Policy Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Employee leave policy template. for your organization.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="leave_policy_download"
                        planName="Remote Work Policy Download"
                        amount={effectivePrice}
                        fileName={`Leave_Policy_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="leave_policy"
                        documentName={`Leave_Policy_${formData.companyName}`}
