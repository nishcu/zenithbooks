...
export default function ShareSubscriptionPage() {
  ...
  useOnDemandUnlock("share_subscription_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Share Subscription Letter Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Letter for subscribing to company shares for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="share_subscription_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Share_Subscription_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="share_subscription"
                        documentName={`Share_Subscription_${formData.employeeName}`}
