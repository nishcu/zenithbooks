...
export default function InvoiceFormatPage() {
  ...
  useOnDemandUnlock("invoice_format_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Invoice Format Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Professional invoice template. for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="invoice_format_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Invoice_Format_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="invoice_format"
                        documentName={`Invoice_Format_${formData.employeeName}`}
