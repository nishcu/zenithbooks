...
export default function AuditorConsentPage() {
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Consent to Act as Auditor</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to give consent to act as auditor.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        fileName={`Board_Resolution_Auditor_Appointment_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="board_resolutions"
                        documentName={`Board_Resolution_Auditor_Appointment_${formData.companyName}`}
