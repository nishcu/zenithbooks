...
import { IndianRupee, Printer, ArrowLeft } from "lucide-react";
...
export default function RentalReceiptPage() {
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: `Rental_Receipt_${tenantName}_${rentalMonth}`,
    });
    ...
    const handleGenerate = () => {
        ...
        // Scroll to receipt and trigger print after a short delay
        setTimeout(() => {
