...
export default function IncomeTaxNoticeReplyPage() {
  ...
  useOnDemandUnlock("income_tax_notice_reply_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Income Tax Notice Reply Draft Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Draft reply to income tax notices for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="income_tax_notice_reply_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Income_Tax_Notice_Reply_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="income_tax_notice_reply"
                        documentName={`Income_Tax_Notice_Reply_${formData.employeeName}`}
