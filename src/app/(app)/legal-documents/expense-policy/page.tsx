...
export default function ExpensePolicyPage() {
  ...
  useOnDemandUnlock("expense_policy_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Expense Policy Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Employee expense and reimbursement policy. for your organization.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="expense_policy_download"
                        planName="Remote Work Policy Download"
                        amount={effectivePrice}
                        fileName={`Expense_Policy_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="expense_policy"
                        documentName={`Expense_Policy_${formData.companyName}`}
