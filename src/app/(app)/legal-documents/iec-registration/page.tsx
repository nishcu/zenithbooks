...
export default function IECRegistrationPage() {
  ...
  useOnDemandUnlock("iec_registration_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Import Export Code (IEC) Draft Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Application draft for IEC registration for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="iec_registration_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`IEC_Registration_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="iec_registration"
                        documentName={`IEC_Registration_${formData.employeeName}`}
