...
export default function DeliveryNotePage() {
  ...
  useOnDemandUnlock("delivery_note_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Delivery Note Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Delivery note/challan template. for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="delivery_note_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Delivery_Note_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="delivery_note"
                        documentName={`Delivery_Note_${formData.employeeName}`}
