...
export default function VestingSchedulePage() {
  ...
  useOnDemandUnlock("vesting_schedule_template_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Vesting Schedule Template Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Template for vesting schedules for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="vesting_schedule_template_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Vesting_Schedule_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="vesting_schedule_template"
                        documentName={`Vesting_Schedule_${formData.employeeName}`}
