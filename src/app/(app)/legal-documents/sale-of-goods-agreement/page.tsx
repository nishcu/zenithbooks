...
export default function SaleOfGoodsAgreementPage() {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      term: "This Agreement will commence on the effective date and will remain in full force and effect until the completion of the Goods, unless terminated earlier as provided in this Agreement.",
