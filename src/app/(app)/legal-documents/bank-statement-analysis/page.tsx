...
export default function BankStatementAnalysisPage() {
  ...
  useOnDemandUnlock("bank_statement_analysis_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Bank Statement Analysis Report Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Template for analyzing bank statements. for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="bank_statement_analysis_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Bank_Statement_Analysis_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="bank_statement_analysis"
                        documentName={`Bank_Statement_Analysis_${formData.employeeName}`}
