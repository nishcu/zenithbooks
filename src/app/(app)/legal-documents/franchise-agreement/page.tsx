...
export default function FranchiseAgreementPage() {
  ...
  useOnDemandUnlock("franchise_agreement_download", () => setShowDocument(true));
        ...
        return (
             <Card>
                ...
                <CardFooter className="justify-between mt-6">
                  ...
                  {(() => {
                    const basePrice = pricing?.agreements?.find(s => s.id === 'franchise_agreement')?.price || 0;
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="franchise_agreement_download"
                        planName="Franchise Agreement Download"
                        amount={effectivePrice}
                        fileName={`Franchise_Agreement_${formData.franchisorName}`}
                        contentRef={printRef}
                        documentType="franchise_agreement"
                        documentName={`Franchise_Agreement_${formData.franchisorName}`}
      ...
      {step === 3 && (
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>Get your Franchise Agreement professionally reviewed and certified by a qualified legal expert.</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Our legal experts will review your franchise agreement for compliance with franchise laws, ensure all necessary clauses are included (territory rights, royalty structure, termination terms, etc.), and provide certification for legal validity and enforceability.
            </p>
          </CardContent>
          <CardFooter>
