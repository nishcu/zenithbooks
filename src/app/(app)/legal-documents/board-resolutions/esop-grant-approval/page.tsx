...
export default function ESOPGrantApprovalPage() {
  ...
  useOnDemandUnlock("esop_grant_approval_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: ESOP Grant Approval</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to approve ESOP grant to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="esop_grant_approval_download"
