...
export default function AdoptMOAAOAPage() {
  ...
  useOnDemandUnlock("adopt_moa_aoa_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Adoption of New MOA/AOA</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to adopt new MOA/AOA to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
