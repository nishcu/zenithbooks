...
export default function IncreaseCapitalPage() {
  ...
  useOnDemandUnlock("increase_capital_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Increase in Authorised Capital</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to increase authorised capital to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="increase_capital_download"
