...
export default function InternalAuditorPage() {
  ...
  useOnDemandUnlock("internal_auditor_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Appointment of Internal Auditor</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to appoint internal auditor to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="internal_auditor_download"
