...
export default function LoanToEquityPage() {
  ...
  useOnDemandUnlock("loan_to_equity_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Conversion of Loan into Equity</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to convert loan to equity to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="loan_to_equity_download"
