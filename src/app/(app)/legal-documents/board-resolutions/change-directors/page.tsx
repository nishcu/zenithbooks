...
export default function ChangeDirectorsPage() {
  ...
  useOnDemandUnlock("change_directors_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Change in Directors</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to change directors to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="change_directors_download"
