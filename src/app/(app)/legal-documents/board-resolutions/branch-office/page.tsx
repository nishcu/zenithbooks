...
export default function BranchOfficePage() {
  ...
  useOnDemandUnlock("branch_office_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Opening Branch Office</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to open branch office to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
