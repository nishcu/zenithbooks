...
export default function ClosureBankAccountPage() {
  ...
  useOnDemandUnlock("closure_bank_account_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Closure of Bank Account</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to close a bank account to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="closure_bank_account_download"
