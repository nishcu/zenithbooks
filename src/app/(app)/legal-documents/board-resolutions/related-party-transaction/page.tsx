...
export default function RelatedPartyTransactionPage() {
  ...
  useOnDemandUnlock("related_party_transaction_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Related Party Transaction Approval</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to approve related party transaction to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="related_party_transaction_download"
                        planName="Board Resolution Download"
                        amount={effectivePrice}
                        fileName={`Board_Resolution_Director_Appointment_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="board_resolutions"
                        documentName={`Board_Resolution_Director_Appointment_${formData.companyName}`}
