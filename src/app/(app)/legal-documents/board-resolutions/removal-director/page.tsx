...
export default function RemovalDirectorPage() {
  ...
  useOnDemandUnlock("removal_director_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Board Resolution: Removal of Director</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate a board resolution to remove a director to the board.
        </p>
      </div>
        <Card>
          <CardHeader>
                  ...
                  {(() => {
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="removal_director_download"
