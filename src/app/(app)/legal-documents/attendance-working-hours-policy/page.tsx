...
export default function AttendanceWorkingHoursPolicyPage() {
  ...
  useOnDemandUnlock("attendance_working_hours_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Attendance & Working Hours Policy Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Define attendance and working hour policies. for your organization.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="attendance_working_hours_download"
                        planName="Remote Work Policy Download"
                        amount={effectivePrice}
                        fileName={`Attendance_Working_Hours_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="attendance_working_hours"
                        documentName={`Attendance_Working_Hours_${formData.companyName}`}
