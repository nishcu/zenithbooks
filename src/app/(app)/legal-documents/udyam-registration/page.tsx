...
export default function UdyamRegistrationPage() {
  ...
  useOnDemandUnlock("udyam_registration_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Udyam Registration Draft Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Support documents for MSME/Udyam registration for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="udyam_registration_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Udyam_Registration_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="udyam_registration"
                        documentName={`Udyam_Registration_${formData.employeeName}`}
