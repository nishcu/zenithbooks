...
export default function BankAccountResolutionPage() {
  ...
  useOnDemandUnlock("bank_account_resolution_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Bank Account Opening Resolution Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Board resolution for opening bank account for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="bank_account_resolution_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Bank_Account_Resolution_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="bank_account_resolution"
                        documentName={`Bank_Account_Resolution_${formData.employeeName}`}
