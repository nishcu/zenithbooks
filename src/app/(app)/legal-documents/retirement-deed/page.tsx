...
export default function RetirementDeedPage() {
  ...
  useOnDemandUnlock("retirement_deed_download", () => setShowDocument(true));

  const { handleCertificationRequest, handlePaymentSuccess, isSubmitting: isCertifying } = useCertificationRequest({
    pricing,
    serviceId: 'retirement_deed'
  });
        ...
        return (
             <Card>
                ...
                <CardFooter className="justify-between mt-6">
                  ...
                  {(() => {
                    const basePrice = pricing?.agreements?.find(s => s.id === 'retirement_deed')?.price || 0;
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="retirement_deed_download"
                        planName="Service Agreement Download"
                        amount={effectivePrice}
                        fileName={`Retirement_Deed_${formData.clientName}`}
                        contentRef={printRef}
                        documentType="retirement_deed"
                        documentName={`Retirement_Deed_${formData.clientName}`}
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Retirement Deed Generator</h1>
        <p className="text-muted-foreground">Deed for partner retirement from firm.</p>
      </div>
      <Form {...form}>
      ...
      {step === 3 && (
        <Card className="mt-8">
          ...
          <CardFooter>
            {pricing && pricing.agreements?.find(s => s.id === 'retirement_deed')?.price > 0 ? (
              <CashfreeCheckout
                amount={pricing.agreements.find(s => s.id === 'retirement_deed')?.price || 0}
                planId="retirement_deed_certification"
