...
export default function FSSAIRegistrationPage() {
  ...
  useOnDemandUnlock("fssai_registration_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">FSSAI Registration Draft Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Food Safety registration application documents for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="fssai_registration_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`FSSAI_Registration_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="fssai_registration"
                        documentName={`FSSAI_Registration_${formData.employeeName}`}
