...
export default function VendorAgreementPage() {
  ...
  useOnDemandUnlock("vendor_agreement_download", () => setShowDocument(true));
        ...
        return (
             <Card>
                ...
                <CardFooter className="justify-between mt-6">
                  ...
                  {(() => {
                    const basePrice = pricing?.agreements?.find(s => s.id === 'vendor_agreement')?.price || 0;
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="vendor_agreement_download"
                        planName="Vendor Agreement Download"
                        amount={effectivePrice}
                        fileName={`Vendor_Agreement_${formData.vendorName}`}
                        contentRef={printRef}
                        documentType="vendor_agreement"
                        documentName={`Vendor_Agreement_${formData.vendorName}`}
      ...
      {step === 3 && (
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>Get your Vendor Agreement professionally reviewed and certified by a qualified legal expert.</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Our legal experts will review your vendor agreement for legal compliance, ensure all necessary clauses are included (payment terms, delivery schedules, quality standards, etc.), and provide certification for legal validity.
            </p>
          </CardContent>
          <CardFooter>
