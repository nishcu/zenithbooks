...
export default function CodeOfConductPage() {
  ...
  useOnDemandUnlock("code_of_conduct_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Code of Conduct Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Employee code of conduct and ethics policy. for your organization.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="code_of_conduct_download"
                        planName="Remote Work Policy Download"
                        amount={effectivePrice}
                        fileName={`Code_Of_Conduct_${formData.companyName}`}
                        contentRef={printRef}
                        documentType="code_of_conduct"
                        documentName={`Code_Of_Conduct_${formData.companyName}`}
