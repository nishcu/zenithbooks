...
export default function GSTLUTPage() {
  ...
  useOnDemandUnlock("gst_lut_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">GST LUT (Letter of Undertaking) Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Generate LUT for export without payment of IGST for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="gst_lut_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`GST_LUT_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="gst_lut"
                        documentName={`GST_LUT_${formData.employeeName}`}
