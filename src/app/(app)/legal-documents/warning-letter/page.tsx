...
export default function WarningLetterPage() {
  ...
  useOnDemandUnlock("warning_letter_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Warning Letter Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Create an official warning letter for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="warning_letter_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Warning_Letter_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="warning_letter"
                        documentName={`Warning_Letter_${formData.employeeName}`}
