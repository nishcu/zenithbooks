...
export default function IndemnityBondPage() {
  ...
  useOnDemandUnlock("indemnity_bond_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Indemnity Bond Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Indemnity bond template for various purposes. for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="indemnity_bond_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Indemnity_Bond_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="indemnity_bond"
                        documentName={`Indemnity_Bond_${formData.employeeName}`}
