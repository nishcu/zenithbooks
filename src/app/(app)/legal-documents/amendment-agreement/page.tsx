...
export default function AmendmentAgreementPage() {
  ...
  useOnDemandUnlock("amendment_agreement_download", () => setShowDocument(true));

  const { handleCertificationRequest, handlePaymentSuccess, isSubmitting: isCertifying } = useCertificationRequest({
    pricing,
    serviceId: 'amendment_agreement'
  });
        ...
        return (
             <Card>
                ...
                <CardFooter className="justify-between mt-6">
                  ...
                  {(() => {
                    const basePrice = pricing?.agreements?.find(s => s.id === 'amendment_agreement')?.price || 0;
                    ...
                    return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="amendment_agreement_download"
                        planName="Service Agreement Download"
                        amount={effectivePrice}
                        fileName={`Amendment_Agreement_${formData.clientName}`}
                        contentRef={printRef}
                        documentType="amendment_agreement"
                        documentName={`Amendment_Agreement_${formData.clientName}`}
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Amendment Agreement Generator</h1>
        <p className="text-muted-foreground">Agreement to amend existing contracts.</p>
      </div>
      <Form {...form}>
      ...
      {step === 3 && (
        <Card className="mt-8">
          ...
          <CardFooter>
            {pricing && pricing.agreements?.find(s => s.id === 'amendment_agreement')?.price > 0 ? (
              <CashfreeCheckout
                amount={pricing.agreements.find(s => s.id === 'amendment_agreement')?.price || 0}
                planId="amendment_agreement_certification"
