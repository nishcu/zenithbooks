...
export default function ShopEstablishmentPage() {
  ...
  useOnDemandUnlock("shop_establishment_download", () => setShowDocument(true));
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold">Shop & Establishment Registration Draft Generator</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Draft application for Shop & Establishment Act registration for employee misconduct or performance issues.
        </p>
      </div>
                ...
                {(() => {
                  ...
                  return (
                      <OnDemandPayAndUseActions
                        ...
                        planId="shop_establishment_download"
                        planName="Warning Letter Download"
                        amount={effectivePrice}
                        fileName={`Shop_Establishment_Registration_${formData.employeeName}`}
                        contentRef={printRef}
                        documentType="shop_establishment"
                        documentName={`Shop_Establishment_Registration_${formData.employeeName}`}
