// Design Tokens for ZenithBooks
// This file contains all design tokens, spacing, colors, and sizing constants
...
export type ComponentSizes = typeof designTokens.componentSizes;
