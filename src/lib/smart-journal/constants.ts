...
export const DEFAULT_CHART_OF_ACCOUNTS: ChartOfAccount[] = [
  ...
  { code: "5001", name: "Office Expenses", type: "Expense", keywords: ["office", "stationery", "stationary", "supplies", "pen", "pens", "paper", "notebook", "file", "folder", "staple", "ink", "printer", "copier", "office supplies", "general office", "office consumables", "office material", "printing", "xerox", "photocopy", "clip", "clips", "pins", "glue", "tape", "envelope", "envelopes", "register", "registers", "office expense", "general expense office", "purchased stationery", "stationery for office"] },
  { code: "6040", name: "Printing & Stationery", type: "Expense", keywords: ["printing", "stationery", "stationary", "print", "xerox", "photocopy", "letterhead", "visiting card", "business card", "visiting cards", "business cards", "print charges", "printing charges", "colour print", "bw print", "binding", "lamination", "printout", "print outs"] },
