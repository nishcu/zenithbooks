...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col w-full max-w-full overflow-x-hidden",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 sm:p-2 text-left text-sm sm:text-base outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-5 sm:[&>svg]:size-6 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-9 sm:h-8 text-sm sm:text-sm",
        sm: "h-8 sm:h-7 text-xs sm:text-xs",
        lg: "h-14 sm:h-12 text-base sm:text-base group-data-[collapsible=icon]:!p-0 [&_[data-sidebar=menu-button-icon]]:size-6 sm:[&_[data-sidebar=menu-button-icon]]:size-6",
      },
    },
    defaultVariants: {
      variant: "default",
...
const SidebarMenuSubItem = React.forwardRef<
  HTMLLIElement,
  React.ComponentProps<"li">
>((props, ref) => <li ref={ref} role="menuitem" {...props} />)
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        size === "sm" && "text-xs sm:text-xs",
        size === "md" && "text-sm sm:text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
