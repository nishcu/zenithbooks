            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>Professional services on ZenithBooks are delivered in accordance with applicable Indian laws and professional regulations. All services are handled by ZenithBooks' internal professional team or platform-managed professional resources.</li>
